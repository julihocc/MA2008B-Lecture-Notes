...
== Source audit for Group 602 exam problems

This audit records how each problem in this solution document relates to the supplementary problems in the lecture notes.

#text(size: 8pt)[
  #table(
    columns: (0.35fr, 1.45fr, 1.45fr, 3.25fr),
    inset: 4pt,
    align: left,
