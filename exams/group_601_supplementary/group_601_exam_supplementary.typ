...
#exam_question(title: "5.1 Phase-Line Analysis")[
  For the autonomous equation $x' = x(x-1)(x-4)$, identify equilibria, determine their stability, and sketch the phase line.
]

#exam_question(title: "5.2 Trace-Determinant Diagram Point")[
  For
  $ A = mat(-2,3;-1,0), $
  compute $(tau, Delta, D)$ and classify the origin.
]

#exam_question(title: "5.3 Fundamental Matrix Computation")[
  For
  $ A(t)=mat(2t,0;0,-3), $
  compute a fundamental matrix and verify invertibility.
]

#exam_question(title: "6.1 Competitive Exclusion Principle Phase Analysis")[
...
#exam_question(title: "6.2 Jacobian Matrix and Local Stability")[
